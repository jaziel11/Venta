...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="#">Abarrotes Angulo</a> -->
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="<?php echo site_url('Cliente/GetAll'); ?>">Clientes <span class="sr-only">(current)</span></a></li>
     ...
     <!--  <form class="navbar-form navbar-left" action="<?php echo site_url('Catalogos/Items'); ?>"   method="post">
        <div class="form-group">
          <input type="text" class="form-control" name="busqueda" placeholder="Articulo" required>
        </div>
